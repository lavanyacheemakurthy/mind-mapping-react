                ...
                <div>
                  {index === props.data.length - 1 ? (
                    <input
                      ...
                      onChange={(e) =>
                        props.updateInputsValues(e, "key", index)
                      }
                    />
                  ) : (
                    current.key
                ...
                <div>
                  {index === props.data.length - 1 ? (
                    <input
                      ...
                      disabled={isTableView}
                      onChange={(e) =>
                        props.updateInputsValues(e, "value", index)
                      }
                    />
                  ) : (
                    current.value
                ...
                <div style={{ display: "flex" }}>
                  {index === props.data.length - 1 && (
                    <div
                      ...
                      onClick={() => {
                        !isTableView && props.updateInputs({ pointer: index, op: "ADD" });
                      }}
                  ...
                  )}
                  {
                    <div
                      onClick={() => {
                        !isTableView && props.updateInputs({ pointer: index, op: "REMOVE" });
                      }}
                    >
                      <MinusSquare />
                    </div>
